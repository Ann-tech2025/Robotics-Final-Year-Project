...
: ${AMENT_CURRENT_PREFIX:="/home/ann/rosbot_ws/src/install/rosbot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosbot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosbot/environment/path.sh"
