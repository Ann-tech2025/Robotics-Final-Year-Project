...
: ${AMENT_CURRENT_PREFIX:="/home/ann/rosbot_ws/src/install/husarion_components_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/husarion_components_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/husarion_components_description/environment/husarion_components_description.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/husarion_components_description/environment/path.sh"
