...
* **/vision_modules**: Python scripts for real-time detection, including:
    * **Emotion Detection**: CNN/CRNN models for facial expression analysis.
...
1. Clone the repo:
   ```bash
   git clone [https://github.com/Ann-tech2025/Robotics-Final-Year-Project.git](https://github.com/Ann-tech2025/Robotics-Final-Year-Project.git)
